...
function test12() {
    var data2016 = [253, 220, 2150, 211, 208, 205, 203, 199, 185, 179, 169, 140, 139, 137, 131, 124, 122, 121, 118, 94, 94, 93, 90, 90, 78, 71, 67, 63, 52, 50, 10];
    var xAxisData = ['安徽', '四川', '江苏', '山西', '广西', '山东', '辽宁', '黑龙江', '吉林', '河南', '广东', '新疆', '甘肃', '宁夏', '内蒙古', '河北', '天津', '北京', '湖南', '湖北', '贵州', '云南', '福建', '重庆', '海南', '上海', '陕西', '青海', '江西', '浙江', '西藏'];
    var std_province_option = {
        title: [
